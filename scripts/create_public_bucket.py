...
Usage (project root, venv active):
    python scripts/create_public_bucket.py               # create it
    python scripts/create_public_bucket.py --destroy     # remove it
    python scripts/create_public_bucket.py --name my-bucket-name
"""
